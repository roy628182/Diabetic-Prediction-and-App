...
with open(r'E:\Data Science & AI\Dataset files\VS code Projects\Diabatic Predication\final_model.pkl', 'rb') as file:
    loaded_model = pickle.load(open(r'E:\Data Science & AI\Dataset files\VS code Projects\Diabatic Predication\final_model.pkl', "rb")) # Load the model from the pickle file
